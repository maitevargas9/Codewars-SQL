-- Description
-- The Dunning-Kruger effect is a cognitive bias in which people wrongly overestimate their knowledge or ability 
-- in a specific area. This tends to occur because a lack of self-awareness prevents them from accurately assessing their skills.
...
-- For each of these users, calculates the difference between the perceived skill level and actual skill level as 
...
-- skill_overestimation: The computed difference between a user's perceived and actual skill levels. It measures the degree of 
-- overconfidence.
-- overconfidence_category: categorization of overconfidence, as described above
-- The query should order the result first by skill overestimation in descending order, and in the case of a tie, by user id in 
-- descending order.
-- To make a task a bit funnier, for random tests, I scrapped the usernames of the current top 100 Codewars users - let's see 
-- which of the Codewars stars have an extreme case of Dunning-Kruger effect 
-- Desired Output
